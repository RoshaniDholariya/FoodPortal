...
//       from: process.env.EMAIL,
//       to: ngo.email,
//       subject: "NGO Application Status Update",
//       text: `Dear ${ngo.name},\n\nWe regret to inform you that your NGO application has been rejected. If you have any questions or would like to appeal this decision, please contact our support team.\n\nBest regards,\nNGO Admin Team`,
//       html: `
//         <!DOCTYPE html>
//         <html>
//         <head>
...
//           <div class="container">
//             <div class="header">
//               <h2 style="color: #333333; margin: 0;">NGO Application Status Update</h2>
//             </div>
//             <div class="content">
//               <p>Dear ${ngo.name},</p>
//               <p>We regret to inform you that after careful consideration, your NGO application has been rejected.</p>

//               <div class="support-box">
//                 <h3 style="margin-top: 0;">Need Assistance?</h3>
//                 <p>Our support team is here to help you understand the decision and guide you through the appeal process if you wish to do so.</p>
//                 <a href="#" class="button">Contact Support</a>
//               </div>

//               <p>We appreciate your interest in our platform and thank you for taking the time to apply.</p>

//               <p>Best regards,<br>NGO Admin Team</p>
//             </div>
...
//     res.status(200).json({
//       success: true,
//       message: "NGO rejected and notification email sent",
//       data: {
//         id: updatedNgo.id,
//         name: updatedNgo.name,
//         rejectedAt: updatedNgo.rejectedAt
//       }
//     });
