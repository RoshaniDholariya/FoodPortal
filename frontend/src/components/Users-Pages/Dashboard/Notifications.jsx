    ...
    async function fetchNotifications() {
      try {
        const res = await axios.get(
          "http://localhost:3000/api/donors/getnotification"
        );
      ...
      <div className="relative">
        ...
        >
          ...
          {notifications.length > 0 && (
            <span className="absolute -top-5 -right-1 bg-red-500 text-white text-xs w-5 h-5 rounded-full flex items-center justify-center">
