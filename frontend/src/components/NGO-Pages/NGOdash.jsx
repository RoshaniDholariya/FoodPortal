      ...
      <div className="lg:ml-64">
        ...
        <main className="max-w-7xl mx-auto px-4 md:px-8 py-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
            <div className="bg-white rounded-xl shadow-md p-6 border border-emerald-100 lg:col-span-2">
              <h2 className="text-xl font-bold mb-6 text-gray-800">
                Donation History
              </h2>
              <div className="h-80">
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={dashboardData?.monthlyDonationData || []}>
                    <CartesianGrid
                      strokeDasharray="3 3"
                      stroke="#e5e7eb"
                      vertical={false}
            ...
            <div className="bg-white rounded-xl shadow-md p-6 border border-emerald-100">
              ...
              <div className="h-80 flex items-center justify-center">
                <ResponsiveContainer width="100%" height="100%">
                  <PieChart>
                    <Pie
                      data={dashboardData?.foodTypeData || []}
                      cx="50%"
                      cy="50%"
                      labelLine={false}
                      outerRadius={80}
                    ...
                    >
                      {(dashboardData?.foodTypeData || []).map(
                        (entry, index) => (
                          <Cell
                            key={`cell-${index}`}
